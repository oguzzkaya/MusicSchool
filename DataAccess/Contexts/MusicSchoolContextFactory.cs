...
namespace DataAccess.Contexts
{
                                                                                   ...
                                                                                   // scaffolding işlemleri için bu class oluşturulmalıdır
    {
        public MusicSchoolContext CreateDbContext(string[] args)
        {
            ...
            optionsBuilder.UseSqlServer("server=.\\SQLEXPRESS;database=MusicSchoolDB2;user id=sa;password=sa;multipleactiveresultsets=true;trustservercertificate=true;");
